...
public class T1215Controller {
  ...
  //@RequestMapping("/test1")
	...
	public String test31Get(Model model) {
		...
		model.addAttribute("address", "서울시 강남구 논현동");
...
//		String address = request.getParameter("address");
	...
	//public String test33Get(HttpServletRequest request, Model model, String name, int age, String address) {
...
//		name = name ==null ? "없음" : name;
//		age = age == null ? "0" : age;
//		address = address ==null ? "미기재" : address;
	...
	@RequestMapping(value="/test43/{mid}/{pwd}")
	public String test43Get(HttpServletRequest request, @PathVariable String mid, @PathVariable String pwd) {
		...
		int secureNum = secureRandom.nextInt(100)+1; // 1~ 100 사이의 난수 발생..
		
		// 앞에서 발생된 난수값을 user에 전송 후 접속할 수 있도록 처리한다.
	...
	public String test11Post(Model model,
			@RequestParam(name="mid", defaultValue="abdcef", required=false) String mid,
