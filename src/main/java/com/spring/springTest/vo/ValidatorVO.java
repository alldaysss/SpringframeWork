...
public class ValidatorVO {
	...
	*/
	...
	@Size(min=4, max=20, message="아이디는 최소 4글자이상, 20글자 이하로 작성하세요!")
	private String mid;
	
	@NotEmpty(message = "비밀번호를 입력하세요?")
	@Size(min=4, max=20, message="비밀번호는 최소 4글자이상, 20글자 이하로 작성하시오!")
	private String pwd;
	
	@Range(min=20, max=99, message = "나이는 최소 20살이상 99살 이하로 작성하시오")
	private int age;
